   ...
   public double sample(double x, double y, double z, double yScale, double yMax, boolean useOrigin) {
      ...
      for(int i = 0; i < this.octaveSamplers.length; ++i) {
         ...
         if (perlinNoiseSampler != null) {
            d += this.field_26445.getDouble(i) * perlinNoiseSampler.sample(maintainPrecision(x * e), useOrigin ? -perlinNoiseSampler.originY : maintainPrecision(y * e), maintainPrecision(z * e), yScale * e, yMax * e) * f;
         }
