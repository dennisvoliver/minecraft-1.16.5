...
public class AffineTransformations {
   ...
   public static final EnumMap<Direction, AffineTransformation> DIRECTION_ROTATIONS = (EnumMap)Util.make(Maps.newEnumMap(Direction.class), (enumMap) -> {
      ...
      enumMap.put(Direction.EAST, new AffineTransformation((Vec3f)null, new Quaternion(new Vec3f(0.0F, 1.0F, 0.0F), 90.0F, true), (Vec3f)null, (Quaternion)null));
      enumMap.put(Direction.WEST, new AffineTransformation((Vec3f)null, new Quaternion(new Vec3f(0.0F, 1.0F, 0.0F), -90.0F, true), (Vec3f)null, (Quaternion)null));
      enumMap.put(Direction.NORTH, new AffineTransformation((Vec3f)null, new Quaternion(new Vec3f(0.0F, 1.0F, 0.0F), 180.0F, true), (Vec3f)null, (Quaternion)null));
      enumMap.put(Direction.UP, new AffineTransformation((Vec3f)null, new Quaternion(new Vec3f(1.0F, 0.0F, 0.0F), -90.0F, true), (Vec3f)null, (Quaternion)null));
      enumMap.put(Direction.DOWN, new AffineTransformation((Vec3f)null, new Quaternion(new Vec3f(1.0F, 0.0F, 0.0F), 90.0F, true), (Vec3f)null, (Quaternion)null));
   });
