...
public interface DispenserBehavior {
   ...
   static void method_27042(BlockPointer blockPointer, Entity entity, Direction direction) {
      entity.setPosition(blockPointer.getX() + (double)direction.getOffsetX() * (0.5000099999997474D - (double)entity.getWidth() / 2.0D), blockPointer.getY() + (double)direction.getOffsetY() * (0.5000099999997474D - (double)entity.getHeight() / 2.0D) - (double)entity.getHeight() / 2.0D, blockPointer.getZ() + (double)direction.getOffsetZ() * (0.5000099999997474D - (double)entity.getWidth() / 2.0D));
   }
}
