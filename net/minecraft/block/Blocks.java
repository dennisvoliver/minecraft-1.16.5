...
public class Blocks {
   ...
   private static PillarBlock createLogBlock(MapColor topMapColor, MapColor sideMapColor) {
      return new PillarBlock(AbstractBlock.Settings.of(Material.WOOD, (blockState) -> {
         return blockState.get(PillarBlock.AXIS) == Direction.Axis.Y ? topMapColor : sideMapColor;
   ...
   static {
      ...
      NETHER_GOLD_ORE = register("nether_gold_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE, MapColor.DARK_RED).requiresTool().strength(3.0F, 3.0F).sounds(BlockSoundGroup.NETHER_GOLD_ORE)));
      ...
      COMMAND_BLOCK = register("command_block", new CommandBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.BROWN).requiresTool().strength(-1.0F, 3600000.0F).dropsNothing()));
      ...
      NETHER_QUARTZ_ORE = register("nether_quartz_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE, MapColor.DARK_RED).requiresTool().strength(3.0F, 3.0F).sounds(BlockSoundGroup.NETHER_ORE)));
      ...
      WHITE_CARPET = register("white_carpet", new CarpetBlock(DyeColor.WHITE, AbstractBlock.Settings.of(Material.CARPET, MapColor.WHITE).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      ORANGE_CARPET = register("orange_carpet", new CarpetBlock(DyeColor.ORANGE, AbstractBlock.Settings.of(Material.CARPET, MapColor.ORANGE).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      MAGENTA_CARPET = register("magenta_carpet", new CarpetBlock(DyeColor.MAGENTA, AbstractBlock.Settings.of(Material.CARPET, MapColor.MAGENTA).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      LIGHT_BLUE_CARPET = register("light_blue_carpet", new CarpetBlock(DyeColor.LIGHT_BLUE, AbstractBlock.Settings.of(Material.CARPET, MapColor.LIGHT_BLUE).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      YELLOW_CARPET = register("yellow_carpet", new CarpetBlock(DyeColor.YELLOW, AbstractBlock.Settings.of(Material.CARPET, MapColor.YELLOW).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      LIME_CARPET = register("lime_carpet", new CarpetBlock(DyeColor.LIME, AbstractBlock.Settings.of(Material.CARPET, MapColor.LIME).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      PINK_CARPET = register("pink_carpet", new CarpetBlock(DyeColor.PINK, AbstractBlock.Settings.of(Material.CARPET, MapColor.PINK).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      GRAY_CARPET = register("gray_carpet", new CarpetBlock(DyeColor.GRAY, AbstractBlock.Settings.of(Material.CARPET, MapColor.GRAY).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      LIGHT_GRAY_CARPET = register("light_gray_carpet", new CarpetBlock(DyeColor.LIGHT_GRAY, AbstractBlock.Settings.of(Material.CARPET, MapColor.LIGHT_GRAY).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      CYAN_CARPET = register("cyan_carpet", new CarpetBlock(DyeColor.CYAN, AbstractBlock.Settings.of(Material.CARPET, MapColor.CYAN).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      PURPLE_CARPET = register("purple_carpet", new CarpetBlock(DyeColor.PURPLE, AbstractBlock.Settings.of(Material.CARPET, MapColor.PURPLE).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      BLUE_CARPET = register("blue_carpet", new CarpetBlock(DyeColor.BLUE, AbstractBlock.Settings.of(Material.CARPET, MapColor.BLUE).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      BROWN_CARPET = register("brown_carpet", new CarpetBlock(DyeColor.BROWN, AbstractBlock.Settings.of(Material.CARPET, MapColor.BROWN).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      GREEN_CARPET = register("green_carpet", new CarpetBlock(DyeColor.GREEN, AbstractBlock.Settings.of(Material.CARPET, MapColor.GREEN).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      RED_CARPET = register("red_carpet", new CarpetBlock(DyeColor.RED, AbstractBlock.Settings.of(Material.CARPET, MapColor.RED).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      BLACK_CARPET = register("black_carpet", new CarpetBlock(DyeColor.BLACK, AbstractBlock.Settings.of(Material.CARPET, MapColor.BLACK).strength(0.1F).sounds(BlockSoundGroup.WOOL)));
      ...
      REPEATING_COMMAND_BLOCK = register("repeating_command_block", new CommandBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.PURPLE).requiresTool().strength(-1.0F, 3600000.0F).dropsNothing()));
      CHAIN_COMMAND_BLOCK = register("chain_command_block", new CommandBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.GREEN).requiresTool().strength(-1.0F, 3600000.0F).dropsNothing()));
      ...
      WARPED_STEM = register("warped_stem", createNetherStemBlock(MapColor.field_25706));
      STRIPPED_WARPED_STEM = register("stripped_warped_stem", createNetherStemBlock(MapColor.field_25706));
      WARPED_HYPHAE = register("warped_hyphae", new PillarBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, MapColor.field_25707).strength(2.0F).sounds(BlockSoundGroup.NETHER_STEM)));
      STRIPPED_WARPED_HYPHAE = register("stripped_warped_hyphae", new PillarBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, MapColor.field_25707).strength(2.0F).sounds(BlockSoundGroup.NETHER_STEM)));
      WARPED_NYLIUM = register("warped_nylium", new NyliumBlock(AbstractBlock.Settings.of(Material.STONE, MapColor.field_25705).requiresTool().strength(0.4F).sounds(BlockSoundGroup.NYLIUM).ticksRandomly()));
      ...
      WARPED_WART_BLOCK = register("warped_wart_block", new Block(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MapColor.field_25708).strength(1.0F).sounds(BlockSoundGroup.WART_BLOCK)));
      ...
      CRIMSON_STEM = register("crimson_stem", createNetherStemBlock(MapColor.field_25703));
      STRIPPED_CRIMSON_STEM = register("stripped_crimson_stem", createNetherStemBlock(MapColor.field_25703));
      CRIMSON_HYPHAE = register("crimson_hyphae", new PillarBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, MapColor.field_25704).strength(2.0F).sounds(BlockSoundGroup.NETHER_STEM)));
      STRIPPED_CRIMSON_HYPHAE = register("stripped_crimson_hyphae", new PillarBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, MapColor.field_25704).strength(2.0F).sounds(BlockSoundGroup.NETHER_STEM)));
      CRIMSON_NYLIUM = register("crimson_nylium", new NyliumBlock(AbstractBlock.Settings.of(Material.STONE, MapColor.field_25702).requiresTool().strength(0.4F).sounds(BlockSoundGroup.NYLIUM).ticksRandomly()));
      ...
      CRIMSON_PLANKS = register("crimson_planks", new Block(AbstractBlock.Settings.of(Material.NETHER_WOOD, MapColor.field_25703).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)));
      WARPED_PLANKS = register("warped_planks", new Block(AbstractBlock.Settings.of(Material.NETHER_WOOD, MapColor.field_25706).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)));
