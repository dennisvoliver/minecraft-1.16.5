...
public class WitherEntity extends HostileEntity implements SkinOverlayOwner, RangedAttackMob {
   ...
   private void method_6878(int i, LivingEntity livingEntity) {
      this.shootSkullAt(i, livingEntity.getX(), livingEntity.getY() + (double)livingEntity.getStandingEyeHeight() * 0.5D, livingEntity.getZ(), i == 0 && this.random.nextFloat() < 0.001F);
   }
