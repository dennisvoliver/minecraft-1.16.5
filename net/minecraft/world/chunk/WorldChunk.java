...
public class WorldChunk implements Chunk {
   ...
   public WorldChunk(World world, ProtoChunk protoChunk) {
      ...
      while(var3.hasNext()) {
         NbtCompound nbtCompound = (NbtCompound)var3.next();
   ...
   public void runPostProcessing() {
      ...
      Iterator var8 = Sets.newHashSet((Iterable)this.pendingBlockEntityNbts.keySet()).iterator();
   ...
   private BlockEntity loadBlockEntity(BlockPos pos, NbtCompound nbt) {
      ...
      if ("DUMMY".equals(nbt.getString("id"))) {
         ...
         blockEntity3 = BlockEntity.createFromTag(blockState, nbt);
      }
