...
public class TestCommand {
      ...
      if (x <= 48 && y <= 48 && z <= 48) {
         ...
         for(int i = 0; i < x; ++i) {
            for(int j = 0; j < z; ++j) {
               ...
               BlockStateArgument blockStateArgument = new BlockStateArgument(block.getDefaultState(), Collections.EMPTY_SET, (NbtCompound)null);
   ...
   private static void run(ServerCommandSource source, Collection<TestFunction> testFunctions, int rotationSteps, int i) {
      ...
      testSet.method_29407((gameTestState) -> {
         TestFunctions.method_29404(gameTestState.method_29403());
      });
   }
