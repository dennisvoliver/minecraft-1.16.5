...
public abstract class ScreenHandler {
   ...
   protected static boolean canUse(ScreenHandlerContext context, PlayerEntity player, Block block) {
      return (Boolean)context.get((world, blockPos) -> {
   ...
   private ItemStack method_30010(int i, int j, SlotActionType slotActionType, PlayerEntity playerEntity) {
      ...
      if (slotActionType == SlotActionType.QUICK_CRAFT) {
         ...
         if ((k != 1 || this.quickCraftStage != 2) && k != this.quickCraftStage) {
            ...
            if (slot != null && canInsertItemIntoSlot(slot, itemStack8, true) && slot.canInsert(itemStack8) && (this.quickCraftButton == 2 || itemStack8.getCount() > this.quickCraftSlots.size()) && this.canInsertIntoSlot(slot)) {
            ...
            if (!this.quickCraftSlots.isEmpty()) {
               ...
               while(true) {
                  ...
                  } while(this.quickCraftButton != 2 && itemStack4.getCount() < this.quickCraftSlots.size());
