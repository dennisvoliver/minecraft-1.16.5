...
public class AddServerScreen extends Screen {
   ...
   protected void init() {
      ...
      this.resourcePackOptionButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 72, 200, 20, getResourcePackOptionText(this.server.getResourcePackPolicy()), (buttonWidget) -> {
      ...
      this.addButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 96 + 18, 200, 20, new TranslatableText("addServer.add"), (buttonWidget) -> {
         this.addAndClose();
      }));
