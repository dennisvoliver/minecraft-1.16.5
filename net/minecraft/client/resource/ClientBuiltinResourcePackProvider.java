...
public class ClientBuiltinResourcePackProvider implements ResourcePackProvider {
   ...
   public CompletableFuture<Void> loadServerPack(File packZip, ResourcePackSource packSource) {
      ...
      }, new TranslatableText("resourcePack.server.name"), packResourceMetadata3.getDescription(), ResourcePackCompatibility.from(packResourceMetadata3.getPackFormat()), ResourcePackProfile.InsertionPosition.TOP, true, packSource);
