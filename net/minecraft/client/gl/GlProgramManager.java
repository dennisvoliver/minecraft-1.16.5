...
public class GlProgramManager {
   ...
   public static void linkProgram(GlShader glShader) throws IOException {
      ...
      if (i == 0) {
         LOGGER.warn((String)"Error encountered when linking program containing VS {} and FS {}. Log output:", (Object)glShader.getVertexShader().getName(), (Object)glShader.getFragmentShader().getName());
