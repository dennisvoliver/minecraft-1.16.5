...
public class PandaEntityRenderer extends MobEntityRenderer<PandaEntity, PandaEntityModel<PandaEntity>> {
   ...
   protected void setupTransforms(PandaEntity pandaEntity, MatrixStack matrixStack, float f, float g, float h) {
      ...
      if (ab > 0.0F) {
         ...
         matrixStack.multiply(Vec3f.POSITIVE_X.getDegreesQuaternion(MathHelper.lerp(ab, pandaEntity.pitch, pandaEntity.pitch + 90.0F)));
      ...
      if (ad > 0.0F) {
         ...
         matrixStack.multiply(Vec3f.POSITIVE_X.getDegreesQuaternion(MathHelper.lerp(ad, pandaEntity.pitch, pandaEntity.pitch + 180.0F)));
      }
