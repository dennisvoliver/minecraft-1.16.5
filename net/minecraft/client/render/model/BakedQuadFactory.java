...
public class BakedQuadFactory {
   ...
   private void rotateVertex(Vec3f vector, @Nullable net.minecraft.client.render.model.json.ModelRotation rotation) {
      if (rotation != null) {
         ...
         case X:
            vec3f7 = new Vec3f(1.0F, 0.0F, 0.0F);
            vec3f8 = new Vec3f(0.0F, 1.0F, 1.0F);
            break;
         case Y:
            vec3f7 = new Vec3f(0.0F, 1.0F, 0.0F);
            vec3f8 = new Vec3f(1.0F, 0.0F, 1.0F);
            break;
         case Z:
            vec3f7 = new Vec3f(0.0F, 0.0F, 1.0F);
         ...
         Quaternion quaternion = new Quaternion(vec3f7, rotation.angle, true);
         if (rotation.rescale) {
